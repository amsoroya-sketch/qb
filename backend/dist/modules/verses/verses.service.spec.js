...
describe('VersesService', () => {
    ...
    beforeEach(async () => {
        const module = await testing_1.Test.createTestingModule({
            providers: [
                verses_service_1.VersesService,
                {
    ...
    describe('findAll', () => {
        ...
        it('should filter by surah number', async () => {
            ...
            expect(mockPrismaService.quranVerse.findMany).toHaveBeenCalledWith(expect.objectContaining({
                where: { surahNumber: 1 },
            }));
        });
    ...
    describe('findOne', () => {
        ...
        it('should throw NotFoundException if verse not found', async () => {
            ...
            await expect(service.findOne(999, 999)).rejects.toThrow(common_1.NotFoundException);
    ...
    describe('getWordAnalysis', () => {
        ...
        it('should throw NotFoundException if word not found', async () => {
            ...
            await expect(service.getWordAnalysis('invalid-id')).rejects.toThrow(common_1.NotFoundException);
        });
    });
    describe('search', () => {
    ...
    describe('createBookmark', () => {
        ...
        it('should throw NotFoundException if verse not found', async () => {
            mockPrismaService.quranVerse.findUnique.mockResolvedValue(null);
            await expect(service.createBookmark('user-1', 999, 999)).rejects.toThrow(common_1.NotFoundException);
        });
    });
    ...
    describe('getUserBookmarks', () => {
        it('should return user bookmarks with verses', async () => {
            ...
            expect(mockPrismaService.bookmark.findMany).toHaveBeenCalledWith(expect.objectContaining({
                where: { userId: 'user-1' },
                include: {
                    verse: {
                        include: {
...
//# sourceMappingURL=verses.service.spec.js.map