...
exports.ExercisesModule = ExercisesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [exercises_service_1.ExercisesService, exercise_generator_service_1.ExerciseGeneratorService],
        exports: [exercises_service_1.ExercisesService, exercise_generator_service_1.ExerciseGeneratorService],
    })
], ExercisesModule);
