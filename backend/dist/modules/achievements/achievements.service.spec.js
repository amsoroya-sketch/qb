...
describe('AchievementsService', () => {
    ...
    describe('findOne', () => {
        ...
        it('should throw NotFoundException if achievement not found', async () => {
            ...
            await expect(service.findOne('nonexistent')).rejects.toThrow('Achievement with ID nonexistent not found');
        });
    });
    describe('getUserAchievements', () => {
        it('should return all achievements with progress for locked ones', async () => {
            const mockProgress = {
                ...
                currentXP: 500,
                totalTimeSpent: 7200,
                averageAccuracy: new client_1.Prisma.Decimal(85),
            };
        ...
        it('should show all unlocked achievements with 100% progress', async () => {
            const mockProgress = {
                ...
                averageAccuracy: new client_1.Prisma.Decimal(95),
            };
            const mockUserAchievements = [
                {
                    id: 'user-achievement-1',
    ...
    describe('checkAndUnlockAchievements', () => {
        ...
        it('should unlock achievement when accuracy requirement is met', async () => {
            const mockProgress = {
                ...
                currentXP: 300,
                totalTimeSpent: 0,
                averageAccuracy: new client_1.Prisma.Decimal(90),
            };
            const mockAchievement = {
                id: 'achievement-7',
    ...
    describe('getAchievementsByCategory', () => {
        ...
        it('should return empty array for category with no achievements', async () => {
            ...
            await expect(service.getAchievementsByCategory('nonexistent')).rejects.toThrow(common_1.NotFoundException);
            await expect(service.getAchievementsByCategory('nonexistent')).rejects.toThrow('No achievements found for category: nonexistent');
        });
        it('should throw error for invalid category', async () => {
            mockPrismaService.achievement.findMany.mockResolvedValue([]);
            await expect(service.getAchievementsByCategory('invalid_category')).rejects.toThrow(common_1.NotFoundException);
        });
    });
