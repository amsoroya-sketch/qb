...
const quran_corpus_mapper_1 = require("./quran-corpus-mapper");
describe('QuranCorpusMapper', () => {
    let mapper;
    beforeEach(() => {
        mapper = new quran_corpus_mapper_1.QuranCorpusMapper();
    });
    describe('mapVerse', () => {
    ...
    describe('mapVerseWords', () => {
        ...
        it('should handle words with missing morphology gracefully', () => {
            ...
            expect(result[0].irabCase).toBe('indeclinable');
        });
    });
    describe('POS mapping', () => {
        it('should map "noun" variations correctly', () => {
            ...
            testCases.forEach(({ input, expected }) => {
                ...
                const result = mapper.mapWord(word);
...
//# sourceMappingURL=quran-corpus-mapper.spec.js.map